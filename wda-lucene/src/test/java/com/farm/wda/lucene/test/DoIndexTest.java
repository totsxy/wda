...
public class DoIndexTest {
	private static File indexDir = new File("D:\\temp\\index");
	/**
	 * @param args
	 * @throws Exception
	 */
	public static void main(String[] args) throws Exception {
		...
		// strList
		// .add("IKAnalyzer是一个开源的，基于java语言开发的轻量级的中文分词工具包。从2006年12月推出1.0版开始，IKAnalyzer已经推出 了3个大版本。最初，它是以开源项目Luence为应...");
		// strList
		// .add("国内情况 悬赏分太少只能帮你到这 了 ...lucene是个全文检索工具 IKAnalyzer是个分词包可以用来做中文的检索 ... ");
		// strList
		// .add("分词器的建议使用，IKAnalyzer，在开源中文分词器里算是很好的，而且一直在稳定的更新版本。 ...建两个Field吧，把内容和路径都建索引，内容分词，路径不...");
		// strList
